...
(custom-set-variables
 ...
 '(ec2-private-key-file '/Volumes/Keys/Test/test-keypair)
 '(ecb-options-version "2.40")
 '(eclim-executable "/Applications/Eclipse.app/Contents/Eclipse/eclim")
 '(eclimd-executable "/Applications/Eclipse.app/Contents/Eclipse/eclimd")
 '(ede-project-directories '("/Users/raghavkarol/github/issuu/backend-stream/python"))
 '(edebug-on-error nil)
 ...
 '(flymake-error-bitmap 'exclation-mark)
 '(flymake-log-level -1)
 '(forge-alist
 ...
 '(org-mobile-index-file "generated-mobile-index.org")
 '(org-refile-targets
   '(("~/org/gtd/someday.org" :regexp . "Inbox")
     ("~/org/gtd/journal.org" :regexp . "Inbox")
     ("~/org/gtd/notes.org" :regexp . "Inbox")
     (org-agenda-files :regexp . "Inbox")))
 '(org-src-fontify-natively t)
 '(org-src-tab-acts-natively t)
 '(org-todo-keywords '((sequence "TODO" "WAIT" "DONE")))
 '(package-selected-packages
   '(chatgpt atomic-chrome projectile counsel pyvenv toml-mode markdown yasnippet company tree-sitter autopair xref-js2 company-go python-mode org-roam-ui org-roam format-all eglot ag wakatime-mode undo-tree ein emamux string-inflection yafolding forge elscreen nginx gerrit-download js-doc helm-xref pug-mode indium ac-js2 tern-auto-complete company-tern json-mode prettier-jsx color-theme-sanityinc-tomorrow groovy flymake-go go-autocomplete nodejs-repl irony irony-mode flycheck haskell haskell-mode deferred info-lookup exec-shell-from-path virtualenv-wrapper auto-pair helm yassnippets yassnippet use-package dockerfile-mode graphviz-dot-mode blank-mode blackboard-theme zenburn-theme synonyms synonymous gradle-mode grandshell-theme magit anti-zenburn-theme wgrep auto-complete-distel ob-restclient markdown-mode sexy-monochrome-theme intellij-theme doom-themes github-browse-file virtualenvwrapper yaml-mode windata wgrep-helm web-mode sqlup-mode sass-mode rvm rsense restclient projectile-rails paredit orgtbl-ascii-plot multi-term imakado idle-highlight-mode highlight-parentheses helm-projectile helm-ls-git helm-git-grep helm-c-yasnippet helm-ag grizzl google-this gnuplot-mode gnuplot expand-region exec-path-from-shell engine-mode elscreen-persist elisp-slime-nav edbi dired+ coffee-mode bookmark+ atom-one-dark-theme atom-dark-theme anaphora ac-python ac-math ac-inf-ruby ac-html ac-helm))
 '(pdf-view-midnight-colors '("#DCDCCC" . "#383838"))
 '(projectile-completion-system 'ivy)
 '(projectile-enable-caching t)
 '(python-indent-guess-indent-offset-verbose nil)
 '(python-shell-exec-path '("/usr/local/bin/python"))
 '(python-shell-interpreter "python")
 '(ring-bell-function 'ignore)
 '(ropemacs-enable-shortcuts nil)
 '(safe-local-variable-values
   '((pyvenv-activate . ~/github/anvilogicrawpipeline/libs/pipeline-models/.venv)
     ...
     (eval progn
           ...
           (setq emamux:pane "1"))
     (jedi:server-args "--virtual-env" "~/github/alertlogic/datadog/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/ae_tools/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/aetag/_venv")
     (jedi:server-args "--virtual-env" "/Users/rkarol-admin/github/alertlogic/aetuner/.tox/_venv")
     (jedi:server-args "--virtual-env" "~/.virtualenvs/_venv" "--sys-path" "~/github/interviewBit/python/")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/ae_ds/py_client/_venv")
     (eval erl-connect-node nil "aefr")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/osint_watchlist/_venv")
     (eval erl-connect-node nil "ae_ds")
     (eval erl-connect-node nil "aetag")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/lwa_firewall_customers/_venv")
     (eval erl-connect-node nil "aecontent")
     ...
     (jedi:server-args "--virtual-env" "~/github/alertlogic/aetag_gun/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/phi/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/pyaetester/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/lwa_publish_metrics/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/aepyclients/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/lwa_service_difference/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/content.integration/_venv")
     (jedi:server-args "--virtual-env" "~/github/alertlogic/aedlq_replay/_venv")
     (jedi:server-args "--virtual-env" "/Users/rkarol-admin/github/alertlogic/aetuner/_venv")
     (jedi:server-args "--virtual-env" "/Users/rkarol-admin/algithub/aetuner/_venv")
     (jedi:server-args "--virtual-env" "/Users/rkarol-admin/algithub/aetuner/.venv")
     (jedi:server-args "--sys-path" "/Users/rkarol-admin/algithub/aetuner/aetuner/server" "--virtual-env" "/Users/rkarol-admin/algithub/aetuner/_venv")
     (jedi:server-args "--sys-path" "/Users/rkarol-admin/algithub/aetuner/aetuner/server" "--virtual-env" "/Users/rkarol-admin/algithub/aetuner/.venv")
     (jedi:server-args "--sys-path" "~/algithub/aetuner/aetuner/server" "--virtual-env" "~/algithub/aetuner/.venv")
     (eval erl-connect-node nil "aepublish")
     (eval erl-connect-node nil "aerta_eng")
     (eval erl-connect-node nil "aerta")
     (jedi:server-args "--virtual-env" "~/algithub/content.integration/_venv/src/content-upload/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_demo/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/content.integration/_venv/")
     (jedi:server-args "--virtual-env" "~/algithub/pyaetester/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/content.integration/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/aeauthentication_customers/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_authentication_customers/_venv")
     (jedi:server-args "--virtual-env" "~/lwa_authentication_customers/_venv")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/aetrigger_eng")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/upgrade_aecommon_lib/aetag")
     (jedi:server-args "--virtual-env" "~/algithub/content.integration//_venv")
     (jedi:server-args "--virtual-env" "~/algithub/content/_venv/src/content-upload/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/aepyclients/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/aedlq_replay/_venv")
     (eval erl-connect-node nil "aecommon_lib")
     (eval erl-connect-node nil "aefr_eng")
     (eval erl-connect nil "aecommon_lib")
     (eval erl-connect nil "aefr_eng")
     (eval erl-connect "aefr_eng")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/aecommon_lib")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_firewall_customers/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/aetag_gun/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_service_differenceg/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_service_difference/_venv")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/aefr/_checkouts/aecommon_lib")
     (jedi:server-args "--virtual-env" "~/algithub/windows_service_inspector_lwa/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/windows_service_inspector_lwa")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_host_probe_tagset/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_host_probe_tagset/_venv/src/aelwasdk/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/content/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/content/venv")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/aerta_eng")
     (jedi:server-args "--virtual-env" "~/algithub/lwa_baseline_demo/_venv")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/aefr_eng")
     (eval setq erl-dev-tools-project-root "/Users/rkarol-admin/github/alertlogic/sessions")
     (eval setq erl-dev-tools-project-root "~/github/alertlogic/sessions")
     (eval progn
           (defun open-ct-logs nil
             (interactive)
             (browse-url-default-browser "file:///Users/rkarol-admin/algithub/sessions/_build/test/logs/suite.log.latest.html")))
     (eval progn
           (defun open-ct-logs-index nil
             (interactive)
             (browse-url-default-browser "_build/test/logs/suite.log.latest.html")))
     (eval progn
           (setq derl-cookie "sessions"))
     (jedi:server-args "--virtual-env" "~/algithub/aesessions_user/_venv")
     (jedi:server-args "--virtual-env" "~/algithub/pylwa/venv")
     (jedi:server-args "--virtual-env" "~/algithub/pylwa/venv/src/aelwasdk/_venv")
     (jedi:server-args "--virtual-env" "~/.virtualenvs/aesessions_user")
     (jedi:server-args "--virtual-env" "~/.virtualenvs/aesessions_user" "--sys-path" "")
     (eval progn
           (setq derl-cookie "aelwa_eng"))
     (eval progn
           (setq derl-cookie "aelwa_py"))
     (jedi:server-args "--virtual-env" "~/algithub/aelwasdk/_venv")
     (eval progn
           (setq derl-cookie "aelwa"))
     (eval progn
           (setq derl-cookie "aeshard_demo"))
     (eval when
           (not
            (string-match-p "/erlang/20.3.8.9/bin"
                            (getenv "PATH")))
           (setenv "PATH"
                   (concat
                    (getenv "HOME")
     ...
     (eval setenv "PATH"
           (concat
            ...
            (getenv "PATH")))
     (eval progn
           (setq derl-cookie "eee_sched"))
     (eval progn
           (setq derl-cookie "eee_kinesis"))
     (eval progn
           (setq derl-cookie "eee_agent"))
     (eval setenv "PATH"
           (concat
            (getenv "HOME")
            "/erlang/20.1.7/bin:"
            (getenv "PATH")))
     (eval progn
           (setq derl-cookie "erl_agent"))
     (eval progn
           (setq derl-cookie "erl_scratch"))
     (eval setenv "PATH"
           (concat
            (getenv "HOME")
            "/erlang/20.3/bin:"
 ...
 '(sql-database "cloud")
 '(sql-mysql-login-params '(user password database server))
 '(sql-mysql-options '("--unbuffered" "-A"))
 ...
 '(visible-bell nil)
 '(wakatime-api-key "ed7b1b0c-3585-4ff5-aa5b-77cf3d92667e")
 '(wakatime-cli-path "/Users/rkarol-admin/wakatime/bin/wakatime")
 '(web-mode-script-padding 0)
 '(wsd-format "png")
 '(wsd-style "modern-blue")
